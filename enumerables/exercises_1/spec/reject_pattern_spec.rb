RSpec.describe 'reject pattern' do
  ...
  it 'removes numbers divisible by 3' do
    ...
    remaining = []
    numbers.each {|num| remaining << num unless num % 3 == 0}
  ...
  it 'removes words longer than 3 letters' do
    ...
    selected = []
    words.each {|word| selected << word unless word.length > 3}
  ...
  it 'removes words ending in e' do
    ...
    selected = []
    words.each {|word| selected << word unless word[-1] == "e"}
  ...
  it 'removes words ending in ing' do
    ...
    selected = []
    words.each {|word| selected << word unless word[-3..-1] == "ing"}
  ...
  it 'removes words containing e' do
    ...
    selected = []
    words.each {|word| selected << word unless word.include?("e")}
  ...
  it 'removes dinosaurs' do
    ...
    notasaurus = []
    animals.each {|animal| notasaurus << animal unless animal.include?("saurus")}
  ...
  it 'removes numbers' do
    ...
    not_numbers = []
    elements.each {|ele| not_numbers << ele unless ele.class == Fixnum || ele.class == Float}
  ...
  it 'removes floats' do
    ...
    not_numbers = []
    elements.each {|ele| not_numbers << ele unless ele.class == Float}
  ...
  it 'removes animals starting with vowels' do
    ...
    remaining = []
    animals.each {|animal| remaining << animal unless ["a", "e", "i", "o", "u", "y"].include?(animal[0]) }
  ...
  it 'removes upcased words' do
    ...
    remaining = []
    words.each {|word| remaining << word unless word.upcase == word}
  ...
  it 'removes arrays' do
    ...
    remaining = []
    elements.each {|ele| remaining << ele unless ele.class == Array}
  ...
  it 'removes hashes' do
    ...
    remaining = []
    elements.each {|ele| remaining << ele unless ele.class == Hash}
