RSpec.describe 'zip pattern' do
  ...
  it 'lottery tickets' do
    ...
    list2 = [298, 166, 237]
    tickets = []
    list1.length.times {|i| tickets << [list1[i], list2[i]]}
  ...
  it 'equivalent dna sequences' do
    ...
    pairs = []
    strand1.length.times {|i| pairs << [strand1[i], strand2[i]]}
  ...
  it 'solitaire' do
    ...
    cards = []
    list1.length.times {|i| cards << [list1[i], list2[i]]}
  ...
  it 'colors' do
    ...
    fashion = []
    list1.length.times {|i| fashion << [list1[i], list2[i]]}
