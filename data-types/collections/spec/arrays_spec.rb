...
RSpec.describe 'Arrays' do
  ...
  it 'test 4' do
    ...
    expect(world_cup.append("Brazil").last).to eq("Brazil")

    # Use a different method to add the element "Japan" to the end of the array

    expect((world_cup << "Japan").last).to eq("Japan")
  end
  ...
  it 'test 5' do
    ...
    last_element = world_cup.slice(-1)
  ...
  it 'test 10' do
    ...
    fourteeners = fourteeners.delete_if {|x| x == nil } 
