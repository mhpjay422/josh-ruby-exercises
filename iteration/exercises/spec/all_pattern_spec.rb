RSpec.describe 'all pattern' do
  ...
  it 'test 5' do
    ...
    all_busy = true
    statuses.each {|stat| all_busy = false if stat != :busy}
  ...
  it 'test 6' do
    ...
    all_busy = true
    friend_status.each {|k, status| all_busy = false if status != :busy}
  ...
  it 'test 7' do
    ...
    zip_codes.each {|zip| all_five_digits = false unless zip > 9999 && zip < 100000}
  ...
  it 'test 8' do
    ...
    all_five_digits = true 
    zip_codes.each {|k, zip| all_five_digits = false unless zip > 9999 && zip < 100000}
  ...
  it 'test 10' do
    ...
    all_caps = true 
    snacks.each {|k, snack| all_caps = false if snack == snack.upcase }
