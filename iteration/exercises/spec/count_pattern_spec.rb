RSpec.describe 'count pattern' do
  ...
  it 'test 6' do
    ...
    multiple_of_three = 0
    ages.each {|k, age| multiple_of_three += 1 if age % 3 == 0}
  ...
  it 'test 7' do
    ...
    family.each {|person| names_with_three_letters += 1 if person.length == 3}
  ...
  it 'test 8' do
    ...
    names_with_three_letters = 0
    family.each {|k, person| names_with_three_letters += 1 if person.length == 3}
  ...
  it 'test 9' do
    ...
    whole_numbers = 0
    prices.each {|price| whole_numbers += 1 if price.to_i == price}
  ...
  it 'test 10' do
    ...
    whole_numbers = 0
    prices.each {|k, price| whole_numbers += 1 if price.to_i == price}
